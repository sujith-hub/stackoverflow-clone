            ...
            <div className='auth-container-2'>
                ...
                <form >
                    ...
                    <label htmlFor='password'>
                        ...
                        {
                            isSignup && (
                                <p style={{ color:"#666767", fontSize:"13px"}}>Password must contain at least eight <br/> 
                    ...
                    </label>
                    {
                        isSignup && (
                            <label htmlFor='check'>
                                ...
                                <p style={{ color:"#666767", fontSize:"13px"}}>Opt-in to receive accasional, <br/> product updates, user reasearch invitations, <br/> company announcements, and digests.</p>
                            </label>
                        )
                    }
